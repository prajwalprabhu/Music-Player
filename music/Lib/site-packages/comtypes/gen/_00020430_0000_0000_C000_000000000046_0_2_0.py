...
IFontDisp = Font
__all__ = [ 'StdPicture', 'OLE_YPOS_CONTAINER', 'IFontDisp',
           'FONTSTRIKETHROUGH', 'OLE_XSIZE_HIMETRIC',
           'LoadPictureConstants', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XSIZE_PIXELS', 'FontEvents', 'OLE_COLOR',
           'OLE_YSIZE_CONTAINER', 'FONTSIZE', 'Default', 'VgaColor',
           'OLE_XSIZE_CONTAINER', 'Unchecked', 'Color', 'FONTBOLD',
           'FONTITALIC', 'OLE_XPOS_CONTAINER', 'FONTNAME',
           'IFontEventsDisp', 'OLE_YPOS_HIMETRIC', 'Picture',
           'FONTUNDERSCORE', 'OLE_YSIZE_HIMETRIC', 'OLE_TRISTATE',
           'IFont', 'Gray', 'OLE_CANCELBOOL', 'Monochrome',
           'OLE_OPTEXCLUSIVE', 'Font', 'OLE_YSIZE_PIXELS', 'StdFont',
           'OLE_HANDLE', 'IPicture', 'OLE_XPOS_PIXELS', 'Checked',
           'IPictureDisp', 'OLE_YPOS_PIXELS', 'OLE_XPOS_HIMETRIC']
